...
export const CATEGORIES = [
  {
    value:       'bda_scheme',
    label:       'BDA Schemes',
    sidebarLabel: 'Authority Schemes',
  ...
  },
  {
    ...
    sidebarLabel: 'Approved Colonies',
  ...
  {
    value:       'suo_moto',
    label:       'Regularized Colonies',
    sidebarLabel: 'Regularized Colonies',
    labelHi:     'नियमित कॉलोनियाँ',
    description: 'Colonies regularized by BDA under the Rajasthan UDA Act.',
    icon:        AlertCircle,
    color:       'amber',
    accent:      'bg-amber-500',
    tint:        'bg-amber-50',
